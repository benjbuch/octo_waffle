...
2. The `data.table` package uses SQL-like syntax; here, `data.frame` is called `data.table`, which is but built for maximum efficiency. 
...
# replicate .1 is systematically higher (for treatments) than the others
