...
```{r eval=FALSE}
bind_cols(
  all_plates[c("sample_id", "replicate_id",  "conc_1")], # half the data.frame, selected with list-operators
  all_plates[c("conc_4", "conc_2", "conc_0", "conc_3")]  # half the data.frame, selected with list-operators
)
```

A more represenative case would look like this.

```{r}
all_plates[c("sample_id", "replicate_id", "conc_1", "conc_2")]
```
